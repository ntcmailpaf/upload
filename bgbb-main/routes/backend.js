...
if (create) {
      ...
      // Your code for creating a table goes here
            ...
            CREATE TABLE IF NOT EXISTS clkTable2 (
    ...
    const tableName = 'clkTable2'; // Replace with the name of the table to delete
    ...
    db.query(deleteQuery, (err, result) => {
      ...
      const query = 'SELECT * FROM clkTable2 ORDER BY notify'; // Replace with your table name
